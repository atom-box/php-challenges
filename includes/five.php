...
<!---------------------Lone Tab Heading-------------------->
  <h2 class="text-left article-title-colors" >E Commerce Store</h2>
<ul class="nav nav-tabs"  role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="challenge-tab" data-toggle="tab" role="tab" aria-controls="challenge" aria-selected="true"><h3>An order for ecommerce.</h3></a>
  </li>
</ul>
<!--------------------- Content-------------------->
...
<code>
A description of an order object:
</code>
<pre>
Data fields of orders:
Order #
Product name
SKU
Live Qty
